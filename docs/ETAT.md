...
_Généré le 2026-09-20 15:00 — ne pas éditer à la main._
...
| SPEC-002 Comptes et authentification des loueurs et conducteurs | ✅ 19/09 | ✅ 20/09 | ✅ 20/09 | 🔄 0/12 stories | 40 exemples |

## Builds autonomes

| Spec | État | Décisions | Majeurs livrés | Action |
|---|---|---:|---:|---|
| SPEC-001 | a-revoir | 32 | 3 | relire `autonomous/SPEC-001.md` |
...
| #25 [US-011] Créer un compte | api | ⚪ todo | https://github.com/ethanlaloum/bookparking/issues/25 |
...
| #1 [SPEC-001] Publier une place de parking en location | — | ⚪ todo | https://github.com/ethanlaloum/bookparking/issues/1 |
...
- carte `e2e` · aucune carte → `/jp-way:map --app e2e`
