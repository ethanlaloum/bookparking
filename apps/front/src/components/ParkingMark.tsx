 ...
 * et c'est aussi le seul endroit ou le bleu accent est impose plutot que
 * derive des tokens — un panneau qui change de couleur n'est plus un panneau.
 */
export const ParkingMark = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 32 32" role="img" aria-hidden="true" className={cn('size-8', className)}>
    <rect width="32" height="32" rx="2" fill="#1f46e0" />
    <path
