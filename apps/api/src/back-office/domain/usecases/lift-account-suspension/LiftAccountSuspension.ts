...
/**
 * Lève la suspension d'un compte. Exige un motif comme la suspension : lever
 * une sanction est une décision autant que la prononcer.
 *
 ...
 * être administrateur.
 */
export class LiftAccountSuspension implements UseCase<
  Props,
  Promise<
    Either.Either<
      void,
  ...
  > {
    try {
      ...
      await this.backOfficeRepository.recordAction({
        ...
        kind: AdminActionKind.LIFT_ACCOUNT_SUSPENSION,
